...
type TaskRequest struct {
	...
	Id      int64  `protobuf:"varint,4,opt,name=id,proto3" json:"id,omitempty"`           //执行任务id
}
...
type TaskResponse struct {
	...
	Output string `protobuf:"bytes,1,opt,name=output,proto3" json:"output,omitempty"` //执行结果标准输出
...
var file_task_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x51, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x38, 0x0a, 0x0c, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x10,
	0x0a, 0x03, 0x65, 0x72, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x72, 0x72,
	0x32, 0x38, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x30, 0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12,
...
var file_task_proto_depIdxs = []int32{
	0, // 0: proto.Task.Run:input_type -> proto.TaskRequest
	1, // 1: proto.Task.Run:output_type -> proto.TaskResponse
...
func (c *taskClient) Run(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.Task/Run", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
